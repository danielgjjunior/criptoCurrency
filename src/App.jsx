    ...
    <div className="main">
      <div className="upperDiv">
        ...
        <div className="authors">
          Daniel Júnior, Carlos Eduardo, Fabiano, Pedro Henrique
        </div>
        <button onClick={fetchCryptoData} className="button">
          Atualizar Dados
        </button>
      </div>

      <div className="downDiv">
        <span className="marketTitle">Valor do Ativo no Mercado</span>
